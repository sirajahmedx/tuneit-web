...
import { X, Plus, Code, Palette, BarChart, Users, Wrench, Lightbulb } from "lucide-react"
...
export function SkillsStep() {
  ...
  const predefinedSkills = [
    { category: "Development", icon: Code, skills: ["JavaScript", "Python", "React", "Node.js", "TypeScript", "SQL"] },
    {
      category: "Design",
      icon: Palette,
    ...
    },
    {
      category: "Analytics",
      icon: BarChart,
      skills: ["Data Analysis", "Google Analytics", "Excel", "Tableau", "Statistics"],
    },
    {
      category: "Marketing",
      icon: Users,
      skills: ["Digital Marketing", "Content Marketing", "SEO", "Social Media", "Email Marketing"],
    },
    {
      category: "Operations",
      icon: Wrench,
      skills: ["Project Management", "Agile", "Scrum", "DevOps", "Quality Assurance"],
    },
    {
      category: "Creative",
      icon: Lightbulb,
      skills: ["Writing", "Photography", "Video Editing", "Illustration", "Copywriting"],
    },
  ]
  ...
  const handleNext = () => {
    ...
    if (data.skills.length === 0) {
      console.log("Skills validation would trigger here - at least one skill required")
      return
    }
  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-3">
        <h2 className="text-3xl font-bold text-balance">What are your skills?</h2>
        <p className="text-muted-foreground text-lg leading-relaxed max-w-lg mx-auto">
          Select your areas of expertise to help us match you with relevant opportunities
        </p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          <Label className="text-sm font-medium">Choose from popular skills</Label>
          <div className="grid gap-4">
            {predefinedSkills.map((category) => {
              const Icon = category.icon
              return (
                <Card key={category.category} className="p-6 hover:shadow-md transition-shadow duration-200">
        ...
        <Card className="p-6 bg-muted/30 border-border/50">
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              disabled={!customSkill.trim() || data.skills.includes(customSkill.trim())}
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Select 3-8 skills that best represent your expertise. You can always update these later in your profile.
              </p>
            </div>
          </div>
        </Card>
      ...
      <StepNavigation onNext={handleNext} nextDisabled={data.skills.length === 0} />
    </div>
  )
}
